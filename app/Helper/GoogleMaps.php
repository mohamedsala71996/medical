...
class GoogleMaps {
    ...
    var $apiKey						= 'AIzaSyDWvmlsDcvt_l6yFexo7Hhfwl3rb-mPe8Q'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
