...
<html >
  <head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">    <title>Hello, world!</title>
...
<div class="container-fluid d-flex justify-content-center  val   ">
    ...
    <form action="{{ route('login') }}" method="post" class="row g-3 needs-validation   justify-content-center  align-items-center   mb-5  ">
      @csrf
        ...
        <div class="">
        <label for="validationCustomUsername" class="form-label" data-Lang="Photo_Personal_Card">Username</label>
        ...
        <a href="forgotpass.html"  class="  text-dark  text-decoration-none    "  data-Lang="Forgot_password">Forgot password</a>
              
 
  
         <button  style=" height: 42px;background-color: #4C3FD7;" class="btn btn-primary customHover "  type="submit" data-Lang="login">login</button>
         <div class="d-flex   gap-1  justify-content-center   m-auto p-3">
            <p data-Lang="don't_have_an_account"> Don't have an account </p>
            <a href="{{route('register')}}" class="text text-primary  text-decoration-underline"  data-Lang="create_New_Account">Create new account</a>
        </div>
        </div>
