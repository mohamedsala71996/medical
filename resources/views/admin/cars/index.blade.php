                    ...
                    <table id="order-listing" class="table display nowrap " cellspacing="0" width="100%">
                        ...
                        @if($cars->count()!=null)
                            ...
                            @foreach($cars as $car)
                                <tr>
                                   {{-- <td>{{$count++}}</td>--}}
                                    <td>@if($car->driver){{$car->driver->name}}@endif</td>
                                    <td>@if($car->driver){{$car->driver->phone}}@endif</td>
                                    <td>
                                        {{$car->brand}}
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('cars.active',$car->id)}}" class="btn btn-gradient-success  btn-sm"  style="padding: 10px">
