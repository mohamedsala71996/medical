    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title">اضافة سائق جديد</h4>
                <form id="example-form" class="forms-sample" method="post" action="{{route('drivers.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input data-validation="required" type="date"  name="birthday" id="birthday" value="{{old('birthday')}}" class="form-control"/>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" @error('national_number') has-danger @enderror>
                                ...
                                <input data-validation="required" type="text" class="form-control" value="{{old('national_number')}}" name="national_number" id="national_number" placeholder="الرقم القومى">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group" @error('brand') has-danger @enderror>
                                ...
                                <input data-validation="required" type="text" class="form-control" value="{{old('brand')}}" name="brand" id="brand" placeholder="فئة السيارة">
                        ...
                        <div class="col-md-4">
                            <div class="form-group" @error('model') has-danger @enderror>
                                ...
                                <input data-validation="required" type="text" class="form-control" value="{{old('model')}}" name="model" id="model" placeholder="الموديل">
                          ...
                          <div class="col-md-4">
                            <div class="form-group" @error('color') has-danger @enderror>
                                ...
                                <input data-validation="required" type="text" class="form-control" value="{{old('color')}}" name="color" id="color" placeholder="اللون">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input data-validation="required" type="file" name="national_image" id="input-file-now-custom-1" class="dropify" data-default-file="" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input data-validation="required" type="file" name="driving_license_image" id="input-file-now-custom-1" class="dropify" data-default-file="" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input data-validation="required" type="file" name="licence_plate1" id="input-file-now-custom-1" class="dropify" data-default-file="" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input data-validation="required" type="file" name="licence_plate2" id="input-file-now-custom-1" class="dropify" data-default-file="" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input data-validation="required" type="file" name="licence_plate3" id="input-file-now-custom-1" class="dropify" data-default-file="" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input data-validation="required" type="file" name="licence_plate4" id="input-file-now-custom-1" class="dropify" data-default-file="" />
