...
@section('nav-links')
    ...
    <li class="breadcrumb-item " aria-current="page">
        ...
        <span></span>تعديل    سعر الكيلو متر
    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title">تعديل     سعر الكيلو متر
                </h4>
                <form id="example-form" class="forms-sample" method="post" action="{{route('prices.update',$price->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
{{--
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>    سعر الكيلو متر
                                </label>
                                <input  required type="number"  name="price" id="price" value="{{$price->price}}" class="form-control"/>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group" @error('email') has-danger @enderror>
                                <label for="email"> وقت الكيلو متر بالثانية</label>
                                <input data-validation="required,double"  type="number" class="form-control" value="{{$price->time}}" name="time" id="balance" placeholder=" ">
