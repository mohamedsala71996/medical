        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="{{route('siteTexts.index')}}">معلومات النظام</a></li>
{{--
...
--}}
                    <li class="nav-item"> <a class="nav-link" href="{{route('socials.index')}}">حسابات السوشيل ميديا</a></li>
                </ul>
            </div>
        </li>
        {{--Admins--}}
