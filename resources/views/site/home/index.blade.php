                ...
                <ins><a href="#" title="">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#deletePostModal{{ $post->id }}">Delete</a></li>
                        </ul>
                    </div>
            ...
            <ul class="we-comet">
                ...
                <li>
                    ...
                    <div class="we-comment">
                        ...
                        <a class="btn btn-danger px-sm-1 rounded-3" href="#" data-bs-toggle="modal" data-bs-target="#deleteCommentModal{{ $comment->id }}">حذف</a>
                    ...
                    <div class="post-comt-box">
                        <form action="{{ route('comments.store') }}" method="post">
                            ...
                            <textarea name="comment" rows="3"
                                placeholder="{{ trans('main.Post_your_comment') }}"></textarea>
                            <input type="hidden" name="post_id" value="{{ $post->id }}">
                            <br>

                            <div class="friend-name" style="margin-top: 5px ">
                                <button class="left btn  btn-outline-dark btn-sm" type="submit">{{ trans('main.Create')
                                    }}</button>
                            </div>
                        </form>
                    </div>
