    ...
    <aside class="sidebar static">
        @if (auth::check())
            {{-- <div class="widget"> --}}
                ...
                {{-- <div class="your-page"> --}}
                    {{-- <figure>
                        <a href="{{ route('siteProfile.index') }}" title=""><img
                                src="{{ url('/' . auth()->user()->image) }}" alt=""></a>
                    </figure> --}}
                    {{-- <div class="page-meta">
                        <a href="{{ route('siteProfile.index') }}" title=""
                            class="underline">{{ trans('main.MyProfile') }}</a>
                        <span><i class="ti-comment"></i><a href="#" title="">{{ trans('main.Groups') }}
                                <em>9</em></a></span>
                        <span><i class="ti-bell"></i><a href="#" title="">{{ trans('main.Notifications') }}
                                <em>2</em></a></span>
                    </div> --}}
                    ...
                    <ul>
                        <li class="me">
                            <div class="chat-thumb"><img
                                    src="{{ url('/') }}/site/images/resources/chatlist1.jpg" alt="">
                            </div>
                        ...
                        <li class="you">
                            <div class="chat-thumb"><img
                                    src="{{ url('/') }}/site/images/resources/chatlist2.jpg" alt="">
                            </div>
                            <div class="notification-event">
                                <span class="chat-message-item">
                                    Hi James! Please remember to buy the food for tomorrow! I’m gonna be handling the
