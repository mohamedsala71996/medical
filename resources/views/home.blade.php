...
<head>
    ...
    <link rel="icon" href="{{url('/')}}/site/images/fav.png" type="image/png" sizes="16x16">
...
<div class="theme-layout">
    ...
    <div class="responsive-header">
        <div class="mh-head first Sticky">
            ...
            <span class="mh-text">
				<a href="newsfeed.html" title=""><img src="{{url('/')}}/site/images/logo2.png" alt=""></a>
			</span>
    ...
    <div class="topbar stick">
        <div class="logo">
            <a title="" href="newsfeed.html"><img src="{{url('/')}}/site/images/logo.png" alt=""></a>
        </div>
        ...
        <div class="top-area">
                        ...
                        <ul class="drops-menu">
                            <li>
                                <a href="notifications.html" title="">
                                    <img src="{{url('/')}}/site/images/resources/thumb-1.jpg" alt="">
                                    <div class="mesg-meta">
                                        <h6>sarah Loren</h6>
                            ...
                            <li>
                                <a href="notifications.html" title="">
                                    <img src="{{url('/')}}/site/images/resources/thumb-2.jpg" alt="">
                                    <div class="mesg-meta">
                                        <h6>Jhon doe</h6>
                                        <span>Hi, how r u dear ...?</span>
                                        <i>2 min ago</i>
                            ...
                            <li>
                                <a href="notifications.html" title="">
                                    <img src="{{url('/')}}/site/images/resources/thumb-3.jpg" alt="">
                                    <div class="mesg-meta">
                                        <h6>Andrew</h6>
                                        <span>Hi, how r u dear ...?</span>
                                        <i>2 min ago</i>
                            ...
                            <li>
                                <a href="notifications.html" title="">
                                    <img src="{{url('/')}}/site/images/resources/thumb-4.jpg" alt="">
                                    <div class="mesg-meta">
                                        <h6>Tom cruse</h6>
                                        <span>Hi, how r u dear ...?</span>
                                        <i>2 min ago</i>
                            ...
                            <li>
                                <a href="notifications.html" title="">
                                    <img src="{{url('/')}}/site/images/resources/thumb-5.jpg" alt="">
                                    <div class="mesg-meta">
                                        <h6>Amy</h6>
                                        <span>Hi, how r u dear ...?</span>
                                        <i>2 min ago</i>
            ...
            <div class="user-img">
                <img src="{{url('/')}}/site/images/resources/admin.jpg" alt="">
                            ...
                            <div class="col-lg-3">
                                <aside class="sidebar static">
                                    ...
                                    <div class="widget stick-widget">
                                        ...
                                        <ul class="followers">
                                            <li>
                                                <figure><img src="{{url('/')}}/site/images/resources/friend-avatar2.jpg" alt=""></figure>
                                            ...
                                            <li>
                                                <figure><img src="{{url('/')}}/site/images/resources/friend-avatar4.jpg" alt=""></figure>
                                                <div class="friend-meta">
                                            ...
                                            <li>
                                                <figure><img src="{{url('/')}}/site/images/resources/friend-avatar6.jpg" alt=""></figure>
                                                <div class="friend-meta">
                                            ...
                                            <li>
                                                <figure><img src="{{url('/')}}/site/images/resources/friend-avatar8.jpg" alt=""></figure>
                                                <div class="friend-meta">
                                            ...
                                            <li>
                                                <figure><img src="{{url('/')}}/site/images/resources/friend-avatar3.jpg" alt=""></figure>
                                                <div class="friend-meta">
                            ...
                            <div class="col-lg-6">
                                <div class="central-meta">
                                    <div class="new-postbox">
                                        <figure>
                                            <img src="{{url('/')}}/site/images/resources/admin2.jpg" alt="">
                                        </figure>
                                ...
                                <div class="loadMore">
                                    <div class="central-meta item">
                                        <div class="user-post">
                                            <div class="friend-info">
                                                <figure>
                                                    <img src="{{url('/')}}/site/images/resources/friend-avatar10.jpg" alt="">
                                                </figure>
                                                ...
                                                <div class="post-meta">
                                                    <img src="{{url('/')}}/site/images/resources/user-post.jpg" alt="">
                                                ...
                                                <ul class="we-comet">
                                                    <li>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <div class="comet-avatar">
                                                                    <img src="{{url('/')}}/site/images/resources/comet-3.jpg" alt="">
                                                                </div>
                                                                <div class="we-comment">
                                                                    <div class="coment-head">
                                    ...
                                    <div class="central-meta item">
                                        <div class="user-post">
                                            <div class="friend-info">
                                                <figure>
                                                    <img src="{{url('/')}}/site/images/resources/nearly6.jpg" alt="">
                                                </figure>
                                                <div class="friend-name">
                            ...
                            <div class="col-lg-3">
                                <aside class="sidebar static">
                                    <div class="widget">
                                        ...
                                        <div class="your-page">
                                            <figure>
                                                <a href="#" title=""><img src="{{url('/')}}/site/images/resources/friend-avatar9.jpg" alt=""></a>
                                            </figure>
                                            <div class="page-meta">
                                    ...
                                    <div class="widget friend-list stick-widget">
                                        ...
                                        <ul id="people-list" class="friendz-list">
                                            <li>
                                                <figure>
                                                    <img src="{{url('/')}}/site/images/resources/friend-avatar.jpg" alt="">
                                                    <span class="status f-online"></span>
                                                </figure>
                                            ...
                                            <li>
                                                <figure>
                                                    <img src="{{url('/')}}/site/images/resources/friend-avatar2.jpg" alt="">
                                            ...
                                            <li>
                                                <figure>
                                                    <img src="{{url('/')}}/site/images/resources/friend-avatar3.jpg" alt="">
                                            ...
                                            <li>
                                                <figure>
                                                    <img src="{{url('/')}}/site/images/resources/friend-avatar4.jpg" alt="">
                                                    <span class="status f-off"></span>
                                                </figure>
                                                <div class="friendz-meta">
                                            ...
                                            <li>
                                                ...
                                                <figure>
                                                    <img src="{{url('/')}}/site/images/resources/friend-avatar5.jpg" alt="">
                                                    <span class="status f-online"></span>
                                                </figure>
                                                <div class="friendz-meta">
                                            ...
                                            <li>
                                                ...
                                                <figure>
                                                    <img src="{{url('/')}}/site/images/resources/friend-avatar6.jpg" alt="">
                                                    <span class="status f-away"></span>
                                                </figure>
                                                <div class="friendz-meta">
                                            ...
                                            <li>
                                                ...
                                                <figure>
                                                    <img src="{{url('/')}}/site/images/resources/friend-avatar7.jpg" alt="">
                                                    <span class="status f-off"></span>
                                                </figure>
                                                <div class="friendz-meta">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="widget">
                        <div class="foot-logo">
                            <div class="logo">
                                <a href="index-2.html" title=""><img src="{{url('/')}}/site/images/logo.png" alt=""></a>
                            </div>
                            <p>
...
<script data-cfasync="false" src="{{url('/')}}/site/../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="js/main.min.js"></script>
